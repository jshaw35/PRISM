...
#SBATCH --job-name=J11_preprocess_spatialmaps
#SBATCH --output=/projects/josh2250/PRISM/job_logs/J11_preprocess_spatialmaps_%A_%a.out
#SBATCH --error=/projects/josh2250/PRISM/job_logs/J11_preprocess_spatialmaps_%A_%a.err
...
python /projects/josh2250/PRISM/J11_preprocess_spatialmaps.py
